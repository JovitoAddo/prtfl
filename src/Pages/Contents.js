...
function Contents() {
  ...
  return (
    <motion.div
      className="flex flex-col content-center bg-cust5 dark:bg-custDark4"
      ...
      // id="#top"
    >
      <div className="bg-cust2 dark:bg-custDark2">
        {/* Photo */}
        ...
        >
          ...
          <img
            src={profile}
            className=" border-8 border-cust4 dark:border-custDark1 hover:border-cust3 active:animate-spin cursor-default"
            style={{ height: "250px" }}
        ...
        <div className="prose container mx-auto grid pt-4 text-center ">
          <motion.div
            initial={{ opacity: 0 }}
            animate={{ opacity: 1, transition: { duration: 3 } }}
            className="text-cust4 text-3xl font-catamaran dark:text-custDark3"
          >
      ...
      {theme === "dark" ? (
        ...
        >
          <path
            ...
            fill="#f9d5a7"
            fill-opacity="0.53"
            class="transition-all duration-300 ease-in-out delay-150 path-0 fill-custDark3"
          ...
          <path
            ...
            fill="#f9d5a7"
            fill-opacity="1"
            class="transition-all duration-300 ease-in-out delay-150 path-1 fill-custDark2"
            transform="rotate(-180 720 250)"
          ></path>
        </svg>
      ) : (
      ...
      <button className="fixed right-1 z-50" onClick={handleSwitch}>
        {theme === "dark" ? (
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-sun stroke-custDay opacity-80"
            width="44"
            height="44"
            viewBox="0 0 24 24"
            stroke-width="1.5"
          ...
          <svg
            xmlns="http://www.w3.org/2000/svg"
            class="icon icon-tabler icon-tabler-moon stroke-custNight opacity-80"
            width="44"
            height="44"
            viewBox="0 0 24 24"
            stroke-width="1.5"
