                  ...
                  <Dialog.Panel className="w-full max-w-md border border-cust3 transform overflow-hidden rounded-2xl bg-cust4 p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-4">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          class="icon icon-tabler icon-tabler-circle-x fill-cust4 hover:fill-cust3 hover:animate-spin"
                          width="35"
                          height="35"
                          viewBox="0 0 24 24"
                          stroke-width="1.5"
                  ...
                  <Dialog.Panel className="w-full border border-cust3 max-w-md transform overflow-hidden rounded-2xl bg-cust4 p-6 text-left align-middle shadow-xl transition-all">
                    ...
                    <div className="mt-4">
                      ...
                      >
                        <svg
                          xmlns="http://www.w3.org/2000/svg"
                          className="icon icon-tabler icon-tabler-circle-x fill-cust4 hover:fill-cust3 hover:animate-spin"
                          width="35"
                          height="35"
                          viewBox="0 0 24 24"
                          strokeWidth="1.5"
